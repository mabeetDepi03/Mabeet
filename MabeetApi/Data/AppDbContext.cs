...
namespace MabeetApi.Data
{
    public class AppDbContext : IdentityDbContext<AppUser>
    {
        ...
        //        "Data Source=DESKTOP-TD4SH89\\SQLEXPRESS;Initial Catalog=MabeetDB;Integrated Security=True;Pooling=False;Encrypt=True;Trust Server Certificate=True"
        //    );
        //}
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // ⭐ إضافة تكوين الـ decimal properties لعلاج الـ warnings
            ...
            modelBuilder.Entity<HotelRoom>()
                .Property(hr => hr.PricePerNight)
                .HasPrecision(18, 2);

            modelBuilder.Entity<LocalLoding>()
                .Property(ll => ll.PricePerNight)
                .HasPrecision(18, 2);
